...
dir_images <- "~/Documents/hackthon/data/first-data-set/images"
eng <- tesseract("eng")
setwd(dir_images)
images <- dir()
n <- length(images)
...
dataFrame <- data.frame(whiteRatio,name_img,sizeRatio,outV)
summary(dataFrame)

# Write CSV in R
write.csv(dataFrame, file = "~/Documents/hackthon/code/MyData.csv")
